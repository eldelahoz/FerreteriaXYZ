...
namespace FerreteriaXYZ.Infraestructure.Contextos
{
    public partial class DbFerreteriaContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) => optionsBuilder.UseSqlServer("Server=192.168.1.9; DataBase=DB_Ferreteria; User ID=sa; Password=FerreteriaXYZ*; TrustServerCertificate=True;");
